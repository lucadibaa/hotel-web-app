...
const CreateAccount = () => {
    ...
    return (
        <section className="px-5 pb-5 bg-white border-b shadow-sm text-asphalt">
            ...
            <div className="flex items-center mb-3">
                ...
                <span className="text-[13px]">Having an account offer easy managing or cancelling your bookings and simplify future bookings.</span>
            </div>

            <div className="flex flex-wrap items-center -mx-2 mt-4 px-4">
                <div className="px-2 w-1/2">
                    <div className="text-sm w-2/3 h-10 pl-2 2xl:w-full">To create your account simply add a secure password in the following input field</div>
                </div>
